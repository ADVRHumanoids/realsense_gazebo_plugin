 ...
 *
 */
#ifndef ROS2DEPTH_CAMERA_HH_
#define ROS2DEPTH_CAMERA_HH_
...
namespace custom
{
  ...
  class GZ_SENSORS_DEPTH_CAMERA_VISIBLE Ros2DepthCamera
      : public gz::sensors::CameraSensor
  {
    /// \brief constructor
      public: Ros2DepthCamera();

    /// \brief destructor
      public: virtual ~Ros2DepthCamera();
  ...
  private: bool CreateCamera();
    ...
    /// \internal
  private: std::unique_ptr<Ros2DepthCameraPrivate> dataPtr;
